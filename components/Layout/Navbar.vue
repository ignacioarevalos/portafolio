...
<template>
  <div class="flex justify-between">
    <a
      href="/"
      aria-label="Inicio"
      class="hover:-translate-y-1 hover:scale-110 hover:cursor-pointer transition ease-in-out delay-75 lg:flex items-center p-3 md:p-4 ml-10 hidden"
      @click.prevent="redireccion('/')"
    >
      <img
